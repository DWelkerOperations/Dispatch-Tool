  ...
  return (
    <div className="space-y-5">
      ...
      <Panel className="print-surface overflow-hidden bg-white">
        <div className="flex items-center justify-between gap-6 border-b-2 border-pride-red px-6 py-5">
          <div>
            <h2 className="text-xl font-bold tracking-tight text-ink">Sample Dispatch Tour Sheet</h2>
            <p className="mt-1 text-sm text-slate-500">Friday, Jan 23, 2026 · Morning bank</p>
          </div>
          <img src={appBranding.logoPath} alt="SkyChefs" className="h-7 w-auto" />
        </div>
