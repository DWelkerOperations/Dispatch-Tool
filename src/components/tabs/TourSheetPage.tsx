  ...
  return (
    <div className="space-y-5">
      ...
      <Panel className="print-surface overflow-hidden bg-white">
        <div className="border-b border-slate-200 px-6 py-5"><h2 className="text-xl font-bold tracking-tight text-ink">Sample Dispatch Tour Sheet</h2><p className="mt-1 text-sm text-slate-500">Friday, Jan 23, 2026 · Morning bank</p></div>
