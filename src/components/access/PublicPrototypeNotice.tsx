  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-mist px-6 py-10">
      <main className="w-full max-w-[520px] rounded-[18px] border border-slate-200 bg-white p-7 shadow-soft">
        <img src={appBranding.logoPath} alt="SkyChefs" className="mb-7 h-9 w-auto" />
        ...
        <button
          className="mt-5 w-full rounded-xl bg-pride-red px-4 py-3 text-sm font-semibold text-white transition hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-200"
          type="button"
